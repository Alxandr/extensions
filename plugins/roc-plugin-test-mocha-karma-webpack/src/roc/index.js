...
export default {
    required: {
        'roc-package-webpack-web-dev': '^2.0.0-alpha.0',
    },
    ...
    actions: [
        ...
        },
        {
            ...
            hook: 'build-webpack',
            description:
                'Adds Webpack configuration specific for tests. Will provide an alias for the src directory, ' +
        ...
        'babel-config': {
            ...
            arguments: {
                ...
                coverage: {
                    validator: isBoolean,
                    description:
                        'If the code should be prepared for coverage generation.',
                },
            },
        },
        'build-karma-config': {
            ...
            arguments: {
                grep: {
                    validator: isString,
                    description:
                        'RegExp that will be compiled by Mocha and limit what tests that should run.',
                },
                watch: {
                    validator: isBoolean,
            ...
            test: {
                ...
                options: {
                    grep: {
                        alias: 'g',
                        description:
                            'Will only run tests that match the given pattern. Will be compiled to a RegExp.',
                        validator: isString,
                    },
                    watch: {
                        alias: 'w',
                    ...
                    coverage: {
                        description:
                            'If coverage reports should be generated for the code.',
                        default: true,
                        validator: isBoolean,
                    },
                },
